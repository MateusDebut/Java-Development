...
public final class ReciprocalArraySum {
    ...
    protected static double seqArraySum(final double[] input) {
        ...
        System.out.printf("parAraySm. Time: %d, whith sum: %8.5f\n", timeInNanos, sum);
    ...
    private static class ReciprocalArraySumTask extends RecursiveAction {
        ...
        protected void compute() {
            if(endIndexExclusive - startIndexInclusive <= 100) {
    ...
    protected static double parArraySum(final double[] input) {
        ...
        long startTime = System.nanoTime();
        ReciprocalArraySumTask reciprocalSumArrayTask = new ReciprocalArraySumTask(0, input.length, input);
        ForkJoinPool.commonPool().invoke(reciprocalSumArrayTask);
        sum = reciprocalSumArrayTask.value;
        long timeInNanos = System.nanoTime() - startTime;
